...
module.exports.stubs.slideMaster1 = {
...
let fs = require('fs');
let my_xml = convert.json2xml(module.exports.stubs.slideMaster1, {compact: false});

console.log("xml = "+my_xml);
fs.writeFileSync(__dirname+"/slideMaster1.stub.xml", my_xml);
