...
class PowerPointFactory {
    ...
    swapSlides(slideName1, slideName2) {
        this.pptFactory.swapSlides(slideName1, slideName2);

        this.slides[slideName1].rename(slideName2);
        this.slides[slideName2].rename(slideName1);

        let tempLayoutName = this.slides[slideName1].getLayout();

        this.slides[slideName1].layout(this.slides[slideName2].getLayout());
        this.slides[slideName2].layout(tempLayoutName);

        // console.log('slideName1 = ', slideName1);
        // console.log('slideName2 = ', slideName2);

        let oldSlide1 = this.slides[slideName1];
        let oldSlide2 = this.slides[slideName2];

        delete this.slides[slideName1];
        delete this.slides[slideName2];

        this.slides[slideName1] = oldSlide2;
        this.slides[slideName2] = oldSlide1;
    }
