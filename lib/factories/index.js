...
class PowerPointFactory {
    ...
    addImageFromRemoteUrl(slide, downloadUrl, options = {}) {
        // TODO: for future support of downloading images from remote sources...
        // 1) Download file in memory
        // 2) Convert to base64
        // 3) Call addImage() with sourceType of base64
        // (Or add another sourceType to pptFactory.addImage() that can accept binary - wouldn't need to base64 convert)
    }
