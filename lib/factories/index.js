...
class PowerPointFactory {
    ...
    addChart(slide, data, options = {}) {
        let newChartContentBlock = this.pptFactory.addChart(slide, data, options);
        let chartObject = new Chart({ parentContainer: slide, powerPointFactory: this, content: newChartContentBlock });
