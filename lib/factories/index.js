...
class PowerPointFactory {
    ...
    addSlide(layoutName) {
        ...
        this.contentTypeFactory.addContentType(`/ppt/slides/${slideName}.xml`, 'application/vnd.openxmlformats-officedocument.presentationml.slide+xml');
    ...
    addImage(slide, path, options) {
        this.pptFactory.addImage(slide.name, path, options);
    }
