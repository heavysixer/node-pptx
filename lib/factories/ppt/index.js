...
class PptFactory {
    ...
    addImage(slide, source, sourceType, options = {}) {
        ...
        this.populateImageSizeOptions(source, sourceType, options);
        return this.slideFactory.addImage(slide, mediaName, rId, options);
    }

    populateImageSizeOptions(imageSource, sourceType, options) {
        if (options.cx === undefined || options.cy === undefined) {
            ...
            let [cx, cy] = [options.cx, options.cy];
            ...
            if (options.cx !== undefined && options.cy === undefined) {
                ...
                cx = options.cx;
                cy = options.cx * ratio;
            } else if (options.cx === undefined && options.cy !== undefined) {
