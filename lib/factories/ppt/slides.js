...
class SlideFactory {
    ...
    addImage(slide, imageFileName, rId, options = {}) {
        ...
        let imageX = options.x !== undefined ? PptxUnitHelper.fromPixels(options.x) : 0;
        let imageY = options.y !== undefined ? PptxUnitHelper.fromPixels(options.y) : 591502;
        let imageCx = options.cx !== undefined ? PptxUnitHelper.fromPixels(options.cx) : 9144000;
        let imageCy = options.cy !== undefined ? PptxUnitHelper.fromPixels(options.cy) : 5674995;
    ...
    addText(slide, text, options = {}) {
        ...
        let textX = options.x !== undefined ? PptxUnitHelper.fromPixels(options.x) : 0;
        let textY = options.y !== undefined ? PptxUnitHelper.fromPixels(options.y) : 0;
        let textCx = options.cx !== undefined ? PptxUnitHelper.fromPixels(options.cx) : 2819400;
        let textCy = options.cy !== undefined ? PptxUnitHelper.fromPixels(options.cy) : 381000;
        ...
        newTextBlock['p:txBody'][0]['a:bodyPr'] = [{ $: { wrap: options.textWrap ? options.textWrap : 'square', rtlCol: '0' } }];
        ...
        if (options.line !== undefined) PptFactoryHelper.addLinePropertiesToBlock(options.line, newTextBlock['p:spPr'][0]);
    ...
    addShape(slide, type, options = {}) {
        ...
        let shapeX = options.x !== undefined ? PptxUnitHelper.fromPixels(options.x) : 0;
        let shapeY = options.y !== undefined ? PptxUnitHelper.fromPixels(options.y) : 0;
        let shapeCx = options.cx !== undefined ? PptxUnitHelper.fromPixels(options.cx) : 2819400;
        let shapeCy = options.cy !== undefined ? PptxUnitHelper.fromPixels(options.cy) : 381000;
        ...
        newShapeBlock['p:txBody'][0]['a:bodyPr'] = [{ $: { anchor: 'ctr', wrap: options.textWrap ? options.textWrap : 'square', rtlCol: '0' } }];
        newShapeBlock['p:txBody'][0]['a:p'] = [{ 'a:pPr': [{ $: { algn: 'ctr' } }] }];

        if (type.avLst !== undefined) PptFactoryHelper.addAvLstToBlock(type.avLst, newShapeBlock['p:spPr'][0]['a:prstGeom'][0]);
        if (options.line !== undefined) PptFactoryHelper.addLinePropertiesToBlock(options.line, newShapeBlock['p:spPr'][0]);
    ...
    addChart(slide, chartName, type, data, options = {}) {
        ...
        let chartX = options.x !== undefined ? PptxUnitHelper.fromPixels(options.x) : 0;
        let chartY = options.y !== undefined ? PptxUnitHelper.fromPixels(options.y) : 0;
        let chartCx = options.cx !== undefined ? PptxUnitHelper.fromPixels(options.cx) : PptxUnitHelper.fromPixels(600);
        let chartCy = options.cy !== undefined ? PptxUnitHelper.fromPixels(options.cy) : PptxUnitHelper.fromPixels(400);
