...
class SlideFactory {
    ...
    addText(slide, textBox) {
        ...
        newTextBlock['p:txBody'][0]['a:p'][0]['a:r'] = [{ 'a:rPr': [{ $: { lang: 'en-US', smtClean: '0' } }], 'a:t': textBox.textValue }];
    ...
    addShape(slide, shape) {
        ...
        if (shape.textValue) {
            newShapeBlock['p:txBody'][0]['a:p'][0]['a:r'] = [{ 'a:rPr': [{ $: { lang: 'en-US', smtClean: '0' } }], 'a:t': shape.textValue }];
