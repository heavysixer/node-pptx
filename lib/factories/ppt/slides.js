...
class SlideFactory {
    ...
    addText(slide, text, options = {}) {
        ...
        if (options.fontFace) {
            ...
            PptFactoryHelper.addFontFaceToBlock(options.fontFace, textRunProperties);
            PptFactoryHelper.addFontFaceToBlock(options.fontFace, endParagraphRun[0]);
        }

        if (typeof options.fontSize === 'number') {
            newTextBlock['p:txBody'][0]['a:p'][0]['a:r'][0]['a:rPr'][0]['$'].sz = `${Math.round(options.fontSize)}00`;
        }
    ...
    addShape(slide, type, options = {}) {
        ...
        if (options.text) {
            ...
            if (options.fontFace) {
                let textRunProperties = newShapeBlock['p:txBody'][0]['a:p'][0]['a:r'][0]['a:rPr'][0];
            ...
            if (typeof options.fontSize === 'number') {
                newShapeBlock['p:txBody'][0]['a:p'][0]['a:r'][0]['a:rPr'][0]['$'].sz = `${Math.round(options.fontSize)}00`;
            }
        }
