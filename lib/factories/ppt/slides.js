...
class SlideFactory {
    ...
    addText(slide, textBox) {
        ...
        PptFactoryHelper.addTextValuesToBlock(newTextBlock['p:txBody'][0], textBox.textValue, options);
    ...
    addShape(slide, shape) {
        ...
        PptFactoryHelper.addTextValuesToBlock(newShapeBlock['p:txBody'][0], shape.textValue, options);
