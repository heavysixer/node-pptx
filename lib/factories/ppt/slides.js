...
class SlideFactory {
    ...
    swapSlides(slideName1, slideName2) {
        let slideKey1 = `ppt/slides/${slideName1}.xml`;
        let slideKey2 = `ppt/slides/${slideName2}.xml`;
        let slideRelsKey1 = `ppt/slides/_rels/${slideName1}.xml.rels`;
        let slideRelsKey2 = `ppt/slides/_rels/${slideName2}.xml.rels`;
    ...
    addShape(slide, shape) {
        ...
        PptFactoryHelper.setTextBodyProperties(newShapeBlock['p:txBody'][0]['a:bodyPr'][0], options);
