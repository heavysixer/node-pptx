...
class SlideFactory {
    ...
    addText(slide, text, options = {}) {
        ...
        if (options.textColor !== undefined) {
            newTextBlock['p:txBody'][0]['a:p'][0]['a:r'][0]['a:rPr'][0]['a:solidFill'] = PptFactoryHelper.createColorBlock(options.textColor);
        }
    ...
    addShape(slide, type, options = {}) {
        ...
        if (options.textWrap) {
            newShapeBlock['p:txBody'][0]['a:bodyPr'][0]['$'].wrap = options.textWrap;
        }
