...
(function() {
    ...
    Sheet = (function() {
        ...
        Sheet.prototype.toxml = function() {
            let c, cols, cw, ht, i, ix, j, l, len, len1, m, mc, n, p, q, r, ref, ref1, ref2, ref3, sd, sid, ws;
    ...
    Style = (function() {
        ...
        Style.prototype.toxml = function() {
            let bders, cs, e, ea, es, fills, fonts, l, len, len1, len2, len3, n, o, p, q, ref, ref1, ref2, ref3, ss;
            ...
            fonts = ss.ele('fonts', { count: this.mfonts.length });
            ...
            fills = ss.ele('fills', { count: this.mfills.length + 2 });
            ...
            bders = ss.ele('borders', { count: this.mbders.length });
