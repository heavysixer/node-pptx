...
class PptFactoryHelper {
    ...
    static addTextValuesToBlock(block, textValues, options) {
        if (Array.isArray(textValues)) {
            //     let lines = textBox.textValue;
            //
            //     for (let i = 0; i < lines.length; i++) {
            //         let lineText = lines[i];
            //         newTextBlock['p:txBody'][0]['a:p'].push({});
            //
            ...
            //
            //         // TODO...
            //         let paragraphBlock = newTextBlock['p:txBody'][0]['a:p'][i];
            ...
            //         }
            //
            //         newTextBlock['p:txBody'][0]['a:p'][i]['a:r'] = [{ 'a:rPr': [{ $: { lang: 'en-US', smtClean: '0' } }], 'a:t': lineText }];
            //
            //         let textRunPropertyBlock = newTextBlock['p:txBody'][0]['a:p'][i]['a:r'][0]['a:rPr'][0];
            ...
            let paragraphBlock = block['a:p'][0];
            PptFactoryHelper.addParagraphPropertiesToBlock(paragraphBlock, options);
