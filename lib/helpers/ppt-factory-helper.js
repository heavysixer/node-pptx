...
class PptFactoryHelper {
    ...
    static addLinePropertiesToBlock(lineProperties, block) {
        if (lineProperties.color) {
            ...
            block['a:ln'][0]['a:solidFill'] = PptFactoryHelper.createColorBlock(lineProperties.color);
        }
    }

    static addAvLstToBlock(avLst, block) {
        block['a:avLst'] = [{ 'a:gd': [] }];
