...
class PptFactoryHelper {
    ...
    static addFontFaceToBlock(fontFace, charset ,block) {
        ...
        block['a:latin'] = [{ $: { typeface: fontFace, pitchFamily: '0', charset: '0' } }];
        block['a:cs'] = [{ $: { typeface: fontFace, pitchFamily: '0', charset: '0' } }];
        block['a:ea'] = [{ $: { typeface: fontFace, pitchFamily: '0', charset: '128' } }];

        charset?.forEach((char) => {
            block[char.key] = [{ $: { typeface: fontFace, pitchFamily: '0', charset: char.charset } }];
        })
    }
    ...
    static setupTextRunPropertiesBlock(textRunPropertyBlock, options) {
        ...
        if (options.fontFace !== undefined) PptFactoryHelper.addFontFaceToBlock(options.fontFace, options.charset, textRunPropertyBlock);
