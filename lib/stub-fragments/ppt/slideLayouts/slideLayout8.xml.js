			...
			elements: [
				{
					type: 'element',
					name: 'p:cSld',
					attributes: { name: 'Content with Caption' },
					elements: [
						{
							type: 'element',
							name: 'p:spTree',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '457200', y: '273050' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '3008313', cy: '1162050' }, elements: [] },
													],
												},
											],
										},
									...
									elements: [
										{
											...
											elements: [
												...
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
												{ type: 'element', name: 'p:nvPr', elements: [{ type: 'element', name: 'p:ph', attributes: { idx: '1' }, elements: [] }] },
											],
										},
										{
											type: 'element',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '3575050', y: '273050' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '5111750', cy: '5853113' }, elements: [] },
													],
												},
											],
										},
										{
											...
											elements: [
												{ type: 'element', name: 'a:bodyPr', elements: [] },
												{
													...
													name: 'a:lstStyle',
													elements: [
														{ type: 'element', name: 'a:lvl1pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '3200' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl2pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2800' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl3pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2400' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl4pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl5pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl6pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl7pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl8pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl9pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
													],
												},
												{
													type: 'element',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '457200', y: '1435100' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '3008313', cy: '4691063' }, elements: [] },
													],
												},
											],
										},
