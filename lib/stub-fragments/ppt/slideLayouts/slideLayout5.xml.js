										...
										{ type: 'element', name: 'p:spPr', elements: [] },
										{
											...
											elements: [
												{ type: 'element', name: 'a:bodyPr', elements: [] },
												{
													type: 'element',
													name: 'a:lstStyle',
													elements: [{ type: 'element', name: 'a:lvl1pPr', elements: [{ type: 'element', name: 'a:defRPr', elements: [] }] }],
												},
												{
													type: 'element',
													name: 'a:p',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '457200', y: '1535113' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '4040188', cy: '639762' }, elements: [] },
													],
												},
											],
										},
													...
													elements: [
														{
															...
															elements: [
																...
																{ type: 'element', name: 'a:defRPr', attributes: { sz: '2400', b: '1' }, elements: [] },
															],
														},
														{
															type: 'element',
															...
															elements: [
																{ type: 'element', name: 'a:buNone', elements: [] },
																{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000', b: '1' }, elements: [] },
															],
														},
														{
															type: 'element',
															...
															elements: [
																{ type: 'element', name: 'a:buNone', elements: [] },
																{ type: 'element', name: 'a:defRPr', attributes: { sz: '1800', b: '1' }, elements: [] },
															],
														},
														{
															type: 'element',
															...
															elements: [
																{ type: 'element', name: 'a:buNone', elements: [] },
																{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600', b: '1' }, elements: [] },
															],
														},
														{
															type: 'element',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '457200', y: '2174875' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '4040188', cy: '3951288' }, elements: [] },
													],
												},
											],
										},
										{
											...
											elements: [
												{ type: 'element', name: 'a:bodyPr', elements: [] },
												{
													...
													name: 'a:lstStyle',
													elements: [
														{ type: 'element', name: 'a:lvl1pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2400' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl2pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '2000' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl3pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1800' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl4pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl5pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl6pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl7pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl8pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
														{ type: 'element', name: 'a:lvl9pPr', elements: [{ type: 'element', name: 'a:defRPr', attributes: { sz: '1600' }, elements: [] }] },
													],
												},
												{
													type: 'element',
									...
									elements: [
										{
											...
											name: 'p:nvSpPr',
											elements: [
												{ type: 'element', name: 'p:cNvPr', attributes: { id: '5', name: 'Text Placeholder 4' }, elements: [] },
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
												{ type: 'element', name: 'p:nvPr', elements: [{ type: 'element', name: 'p:ph', attributes: { type: 'body', sz: 'quarter', idx: '3' }, elements: [] }] },
											],
										},
										{
											type: 'element',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '4645025', y: '1535113' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '4041775', cy: '639762' }, elements: [] },
													],
												},
											],
										},
									...
									elements: [
										{
											...
											name: 'p:nvSpPr',
											elements: [
												{ type: 'element', name: 'p:cNvPr', attributes: { id: '6', name: 'Content Placeholder 5' }, elements: [] },
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
												{ type: 'element', name: 'p:nvPr', elements: [{ type: 'element', name: 'p:ph', attributes: { sz: 'quarter', idx: '4' }, elements: [] }] },
											],
										},
										{
											type: 'element',
											...
											elements: [
												{
													...
													name: 'a:xfrm',
													elements: [
														{ type: 'element', name: 'a:off', attributes: { x: '4645025', y: '2174875' }, elements: [] },
														{ type: 'element', name: 'a:ext', attributes: { cx: '4041775', cy: '3951288' }, elements: [] },
													],
												},
											],
										},
									...
									elements: [
										{
											...
											name: 'p:nvSpPr',
											elements: [
												{ type: 'element', name: 'p:cNvPr', attributes: { id: '7', name: 'Date Placeholder 6' }, elements: [] },
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
									...
									elements: [
										{
											...
											name: 'p:nvSpPr',
											elements: [
												{ type: 'element', name: 'p:cNvPr', attributes: { id: '8', name: 'Footer Placeholder 7' }, elements: [] },
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
									...
									elements: [
										{
											...
											name: 'p:nvSpPr',
											elements: [
												{ type: 'element', name: 'p:cNvPr', attributes: { id: '9', name: 'Slide Number Placeholder 8' }, elements: [] },
												{ type: 'element', name: 'p:cNvSpPr', elements: [{ type: 'element', name: 'a:spLocks', attributes: { noGrp: '1' }, elements: [] }] },
												{
													type: 'element',
													name: 'p:nvPr',
