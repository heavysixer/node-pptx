...
let { PresentationFactory } = require('./factories');
...
class Presentation {
	constructor(args) {
		this.args = args;
		this.content = {};
		this.presentationFactory = new PresentationFactory(args, this.content);
	...
	buildPowerPoint() {
		...
		this.presentationFactory.setPowerPowerPointProperties(this.properties);
	}
