...
class TextBox extends ElementProperties {
    ...
    rotation(value) {
        ...
        let finalDegreeRot = mod(value, 360); // this should handle negative rotations automatically (ex: -90 MOD 360 = 270) and over-rotations (ex: 370 MOD 360 = 10)
        this.options.rotation = Math.floor(finalDegreeRot); // see my notes in the mod() function for why I wrote a custom modulo operation instead of using "%"
